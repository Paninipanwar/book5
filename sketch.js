...
function setup() {
  ...
  img.size(70, 50); // Set the size of the image to match the button
...
function onButtonHover() {
  isHovered = true;
  customImageWidth = 400; // Change the width when hovering
  customImageHeight = 195; // Change the height when hovering
